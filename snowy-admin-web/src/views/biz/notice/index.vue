		...
		<s-table ref="tableRef" :columns="columns" :data="loadData" :alert="options.alert.show" bordered
			...
			<template #operator class="table-operator">
				<a-space>
					...
					<xn-batch-button v-if="hasPerm('bizNoticeBatchDelete')" buttonName="Batch Delete" icon="DeleteOutlined"
						buttonDanger :selectedRowKeys="selectedRowKeys" @batchCallBack="deleteBatchBizNotice" />
				</a-space>
			</template>
			<template #bodyCell="{ column, record }">
				...
				<template v-if="column.dataIndex === 'action'">
					<a-space>
						...
						<a @click="formRef.onOpen(record)" v-if="hasPerm('bizNoticeEdit')">Edit</a>
