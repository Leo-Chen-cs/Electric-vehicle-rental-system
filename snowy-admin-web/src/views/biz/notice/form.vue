<template>
	<xn-form-container :title="formData.id ? 'Edit通知公告' : '增加通知公告'" :width="1000" v-model:open="open"
			...
			<a-row :gutter="16">
				...
				<a-col :span="24">
					<a-form-item label="摘要：" name="digest">
						<a-textarea v-model:value="formData.digest" placeholder="请输入摘要" :auto-size="{ minRows: 3, maxRows: 5 }"
							:showCount="true" :maxlength="60" />
					</a-form-item>
				</a-col>
				<a-col :span="18">
