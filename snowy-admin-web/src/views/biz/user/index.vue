<template>
		...
		<a-col :xs="24" :sm="24" :md="24" :lg="19" :xl="19">
			...
			<a-card :bordered="false">
				<s-table ref="tableRef" :columns="columns" :data="loadData" :expand-row-by-click="true" bordered
					:alert="options.alert.show" :tool-config="toolConfig" :row-key="(record) => record.id"
					...
					<template #operator class="table-operator">
						<a-space>
							...
							<xn-batch-button v-if="hasPerm('bizUserBatchDelete')" :buttonName="$t('common.batchRemoveButton')"
								icon="DeleteOutlined" buttonDanger :selectedRowKeys="selectedRowKeys"
	...
	<xn-role-selector ref="RoleSelectorPlusRef" :org-tree-api="selectorApiFunction.orgTreeApi"
		:role-page-api="selectorApiFunction.rolePageApi" :add-show="false" :role-global="true" @onBack="roleBack" />
</template>
