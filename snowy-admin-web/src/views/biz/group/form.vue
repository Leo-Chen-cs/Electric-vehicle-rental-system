<template>
	<xn-form-container :title="formData.id ? 'Edit用户组' : '增加用户组'" :width="700" v-model:open="open"
		...
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
			...
			<a-form-item label="排序码：" name="sortCode">
				<a-input-number v-model:value="formData.sortCode" placeholder="请输入排序码" :min="1" :max="10000"
					style="width: 100%" />
			</a-form-item>
		</a-form>
		<template #footer>
