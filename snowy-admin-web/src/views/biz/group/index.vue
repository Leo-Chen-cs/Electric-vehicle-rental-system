<template>
		...
		<s-table ref="tableRef" :columns="columns" :data="loadData" :alert="options.alert.show" bordered
			...
			<template #operator class="table-operator">
				<a-space>
					...
					<xn-batch-button v-if="hasPerm('bizGroupBatchDelete')" buttonName="Batch Delete" icon="DeleteOutlined"
						buttonDanger :selectedRowKeys="selectedRowKeys" @batchCallBack="deleteBatchBizGroup" />
				</a-space>
			</template>
			<template #bodyCell="{ column, record }">
				<template v-if="column.dataIndex === 'action'">
					<a-space>
						<a @click="formRef.onOpen(record)" v-if="hasPerm('bizGroupEdit')">Edit</a>
	...
	<xn-user-selector ref="userSelectorRef" :org-tree-api="selectorApiFunction.orgTreeApi"
