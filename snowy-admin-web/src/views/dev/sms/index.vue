<template>
			...
			<a-row :gutter="24">
				<a-col :span="8">
					<a-form-item name="engine" label="短信引擎">
						<a-select v-model:value="searchFormState.engine" :options="engineOptions" placeholder="请选择短信引擎"
							:getPopupContainer="(trigger) => trigger.parentNode" allow-clear></a-select>
					</a-form-item>
				</a-col>
				<a-col :span="8">
	...
	<a-card :bordered="false">
		<s-table ref="tableRef" :columns="columns" :data="loadData" :expand-row-by-click="true" :alert="options.alert.show"
			...
			<template #operator class="table-operator">
				<a-space>
					...
					<xn-batch-button buttonName="Batch Delete" icon="DeleteOutlined" buttonDanger
						:selectedRowKeys="selectedRowKeys" @batchCallBack="deleteBatchSms" />
				</a-space>
			</template>
