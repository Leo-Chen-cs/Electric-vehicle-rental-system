			...
			<a-row :gutter="16">
				<a-col :span="3">
					<a-form-item label="系统LOGO：" name="SNOWY_SYS_LOGO">
						<a-upload v-model:file-list="formData.SNOWY_SYS_LOGO" class="avatar-uploader" list-type="picture-card"
							:show-upload-list="false" :custom-request="customRequest" accept="image/png, image/jpeg, image/jpg">
			...
			<a-row :gutter="16">
				...
				<a-col :span="8">
					<a-form-item label="验证码开关：" name="SNOWY_SYS_DEFAULT_CAPTCHA_OPEN">
						<a-radio-group v-model:value="formData.SNOWY_SYS_DEFAULT_CAPTCHA_OPEN" :options="commonSwitchOptions"
							placeholder="请选择验证码开关"></a-radio-group>
					</a-form-item>
				</a-col>
				<a-col :span="8">
					<a-form-item label="默认文件引擎：" name="SNOWY_SYS_DEFAULT_FILE_ENGINE">
						<a-radio-group v-model:value="formData.SNOWY_SYS_DEFAULT_FILE_ENGINE" :options="fileEngineOptions"
							placeholder="请选择系统默认文件引擎"></a-radio-group>
					</a-form-item>
				</a-col>
			</a-row>
			<a-row :gutter="16">
				...
				<a-col :span="8">
					<a-form-item label="系统描述：" name="SNOWY_SYS_DEFAULT_DESCRRIPTION">
						<a-textarea v-model:value="formData.SNOWY_SYS_DEFAULT_DESCRRIPTION" placeholder="请输入系统描述"
			...
			<a-row :gutter="16">
				<a-col :span="24">
					<a-form-item>
						...
						<a-button class="xn-ml10" @click="resetForm">Reset</a-button>
					</a-form-item>
				</a-col>
			</a-row>
		</a-form>
...
const formRules = {
	...
	SNOWY_SYS_DEFAULT_PASSWORD: [required('请输入系统Reset密码默认密码')]
}
// 表单固定label实现
const labelCol = ref({
	style: {
