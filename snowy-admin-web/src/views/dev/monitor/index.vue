	...
	<a-spin :spinning="spinning">
			...
			<a-col :span="6">
				<a-card title="CPU监控" :bordered="false" class="monitor-center-row-col-card">
					<a-tooltip>
						...
						<a-progress type="dashboard" :stroke-color="getProgressColor(devMonitorCpuInfo.cpuTotalUseRate)"
			...
			<a-col :span="6">
				<a-card title="内存信息" :bordered="false" class="monitor-center-row-col-card">
					<a-tooltip>
						...
						<a-progress type="dashboard" :stroke-color="getProgressColor(devMonitorMemoryInfo.memoryUseRate)"
			...
			<a-col :span="6">
				<a-card title="存储信息" :bordered="false" class="monitor-center-row-col-card">
					<a-tooltip>
						...
						<a-progress type="dashboard" :stroke-color="getProgressColor(devMonitorStorageInfo.storageUseRate)"
			...
			<a-col :span="6">
				<a-card title="网络信息" :bordered="false" class="monitor-center-row-col-card">
					...
					<a-spin :spinning="networkSpinning">
						<a-statistic title="上行速率" :value="devMonitorNetworkInfo.upLinkRate" :precision="2"
							:value-style="{ color: '#3f8600' }">
							<template #prefix>
								<arrow-up-outlined />
							</template>
						</a-statistic>
						<a-statistic class="mt-4" title="下行速率" :value="devMonitorNetworkInfo.downLinkRate" :precision="2"
			...
			<a-col :span="6">
				<a-card title="JVM监控" :bordered="false" class="monitor-center-row-col-card">
					<a-tooltip>
						...
						<a-progress type="dashboard" :stroke-color="getProgressColor(devMonitorJvmInfo.jvmUseRate)"
		...
		<a-card title="服务器信息" :bordered="false" class="mb-2">
			<a-descriptions size="middle" :column="2" bordered>
				...
				<a-descriptions-item label="服务器Operation系统">{{ devMonitorServerInfo.serverOs }}</a-descriptions-item>
