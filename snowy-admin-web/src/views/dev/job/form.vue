<template>
	<xn-form-container :title="formData.id ? 'Edit定时任务' : '增加定时任务'" :width="550" :visible="visible"
		...
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
			...
			<a-form-item label="扩展参数：" name="extJson">
				<a-textarea v-model:value="formData.extJson" placeholder="请输入定时扩展参数" :auto-size="{ minRows: 2, maxRows: 5 }"
					allow-clear />
			</a-form-item>
