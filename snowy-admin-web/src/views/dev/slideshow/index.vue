	...
	<a-card :bordered="false">
		...
		<s-table ref="tableRef" :columns="columns" :data="loadData" :alert="options.alert.show" bordered
			...
			<template #expandedRowRender="{ record }">
				<a-table size="middle" :dataSource="JSON.parse(record.pathDetails)" :columns="detailsColumns"
			...
			<template #operator class="table-operator">
				<a-space>
					...
					<xn-batch-button buttonName="Batch Delete" icon="DeleteOutlined" buttonDanger
						:selectedRowKeys="selectedRowKeys" @batchCallBack="deleteBatchDevSlideshow" />
				</a-space>
			</template>
			<template #bodyCell="{ column, record }">
