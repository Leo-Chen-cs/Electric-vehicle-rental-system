<template>
	<a-form ref="emailResetFormRef" :model="emailFormData" :rules="formRules">
		...
		<a-form-item name="emailValidCode">
			<a-row :gutter="8">
				<a-col :span="17">
					<a-input v-model:value="emailFormData.emailValidCode" :placeholder="$t('login.emailCodePlaceholder')"
						size="large">
						<template #prefix>
							<mail-outlined class="xn-color-00025" />
						</template>
		...
		<a-form-item name="newPassword">
			<a-input-password v-model:value="emailFormData.newPassword" :placeholder="$t('login.newPwdPlaceholder')"
				size="large">
				<template #prefix>
	...
	<a-modal v-model:open="visible" :width="400" :title="$t('login.machineValidation')" @cancel="handleCancel"
		@ok="handleOk">
		<a-form ref="emailLoginFormModalRef" :model="emailFormModalData" :rules="formModalRules">
			<a-form-item name="validCode">
				<a-row :gutter="8">
					<a-col :span="17">
						<a-input v-model:value="emailFormModalData.validCode" :placeholder="$t('login.validLaceholder')"
							size="large">
							<template #prefix>
