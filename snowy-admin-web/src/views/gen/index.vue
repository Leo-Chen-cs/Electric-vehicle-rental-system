<template>
	<a-card :bordered="false" v-if="indexShow">
		<s-table ref="tableRef" :columns="columns" :data="loadDate" :expand-row-by-click="true" :alert="options.alert.show"
			...
			<template #operator class="table-operator">
				<a-space>
					...
					<xn-batch-button buttonName="Batch Delete" icon="DeleteOutlined" buttonDanger
						:selectedRowKeys="selectedRowKeys" @batchCallBack="deleteBatchCodeGen" />
				</a-space>
			</template>
