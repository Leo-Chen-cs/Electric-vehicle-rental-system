<template>
	<xn-form-container title="授权移动端资源" :width="drawerWidth" :visible="visible" :destroy-on-close="true"
		:show-pagination="false" @close="onClose">
		<a-spin :spinning="spinningLoading">
			<a-radio-group v-model:value="moduleId" button-style="solid" class="xn-pb10">
				<a-radio-button :key="module.id" v-for="module in echoDatalist" :value="module.id"
...
const loadData = async () => {
	// firstShowMap = {} // Reset单元格合并映射
	// 如果有数据，我们再不去反复的Search
