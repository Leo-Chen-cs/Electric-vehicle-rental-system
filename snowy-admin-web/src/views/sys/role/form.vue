<template>
	<xn-form-container :title="formData.id ? 'Edit角色' : '增加角色'" :width="550" :visible="visible" :destroy-on-close="true"
		@close="onClose">
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
			...
			<a-form-item label="角色分类：" name="category">
				<a-select v-model:value="formData.category" :options="categoryOptions" class="xn-wd" placeholder="请选择角色分类" />
			</a-form-item>
