<template>
	<xn-form-container :title="formData.id ? 'Edit用户' : '增加用户'" :width="800" :visible="visible" :destroy-on-close="true"
								...
								<a-col :span="7">
									<a-form-item :name="['positionJson', index, 'positionId']"
										...
										<xn-page-select ref="xnChildPositionPageSelectRef" v-model:value="positionInfo.positionId"
											placeholder="请选择职位" allow-clear :page-function="selectApiFunction.childPositionSelector"
											:echo-function="selectApiFunction.echoPosition" />
									</a-form-item>
								</a-col>
								<a-col :span="7">
